...
define gui.accent_color = '#6e77f1'

## The color used for a text button when it is neither selected nor hovered.
define gui.idle_color = '#c5c2d6'

## The small color is used for small text, which needs to be brighter/darker to
## achieve the same effect.
define gui.idle_small_color = '#d0e3d3'

## The color that is used for buttons and bars that are hovered.
define gui.hover_color = '#6e77f1'
...
define gui.insensitive_color = '#6e77f17f'

## Colors used for the portions of bars that are not filled in. These are not
## used directly, but are used when re-generating bar image files.
define gui.muted_color = '#3c2880'
define gui.hover_muted_color = '#5c5895'
...
define gui.choice_button_text_idle_color = '#d0e3d3'
define gui.choice_button_text_hover_color = "#ffffff"
define gui.choice_button_text_insensitive_color = '#d0e3d37f'
